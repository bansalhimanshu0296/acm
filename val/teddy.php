...
if( isset($_POST['quote']))
{
	...
	$insert=mysql_query("INSERT INTO teddy VALUES(NULL,'$quote')");


header('Location: teddy.php?success');
exit();
...
<form action="teddy.php" method="POST">
    ...
    <center><textarea type="text" rows="7" name="quote" placeholder="teddy quote" required="required"></textarea><br><br>
