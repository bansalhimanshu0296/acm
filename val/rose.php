...
if( isset($_POST['quote']))
{
	...
	$insert=mysql_query("INSERT INTO rose VALUES(NULL,'$quote')");


header('Location: rose.php?success');
exit();
...
<form action="rose.php" method="POST">
    ...
    <center><textarea type="text" rows="7" name="quote" placeholder="rose quote" required="required"></textarea><br><br>
