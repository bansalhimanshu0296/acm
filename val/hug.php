...
if( isset($_POST['quote']))
{
	...
	$insert=mysql_query("INSERT INTO hug VALUES(NULL,'$quote')");


header('Location: hug.php?success');
exit();
...
<form action="hug.php" method="POST">
  
    <center><textarea type="text" rows="7" name="quote" placeholder="hug quote" required="required"></textarea><br><br>
