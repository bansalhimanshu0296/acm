...
if( isset($_POST['quote']))
{
	...
	$insert=mysql_query("INSERT INTO propose VALUES(NULL,'$quote')");


header('Location: propose.php?success');
exit();
...
<form action="propose.php" method="POST">
    ...
    <center><textarea type="text" rows="7" name="quote" placeholder="propose quote" required="required"></textarea><br><br>
