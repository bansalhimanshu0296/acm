...
if( isset($_POST['quote']))
{
	...
	$insert=mysql_query("INSERT INTO promise VALUES(NULL,'$quote')");


header('Location: promise.php?success');
exit();
...
<form action="promise.php" method="POST">
  
    <center><textarea type="text" rows="7" name="quote" placeholder="promise quote" required="required"></textarea><br><br>
