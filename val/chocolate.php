...
if( isset($_POST['quote']))
{
	...
	$insert=mysql_query("INSERT INTO chocolate VALUES(NULL,'$quote')");


header('Location: chocolate.php?success');
exit();
...
<form action="chocolate.php" method="POST">
  
    <center><textarea type="text" rows="7" name="quote" placeholder="chocolate quote" required="required"></textarea><br><br>
