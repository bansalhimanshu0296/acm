...
if( isset($_POST['quote']))
{
	...
	$insert=mysql_query("INSERT INTO kiss VALUES(NULL,'$quote')");


header('Location: kiss.php?success');
exit();
...
<form action="kiss.php" method="POST">
  
    <center><textarea type="text" rows="7" name="quote" placeholder="kiss quote" required="required"></textarea><br><br>
